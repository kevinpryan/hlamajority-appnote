...
ggsave(plot = figure, filename = "/hlamajority-paper/results/app_note/plots/hlamajority-1000genomes-wgs.svg", width = 20, height = 7)
ggsave(plot = figure, filename = "/hlamajority-paper/results/app_note/plots/hlamajority-1000genomes-wgs.pdf", width = 10, height = 15)
