...
ggsave(plot = plots_arranged_title, filename = "../claeys-et-al/claeys-plots-adjust-yaxis.png", device = "png", 
                                    width = 30, 
                                    height = 15,
                                    units = "cm",
                                    dpi = 500)
ggsave(plot = plots_arranged_title, filename = "../claeys-et-al/claeys-plots-adjust-yaxis.pdf", width = 20, height = 10)
ggsave(plot = plots_arranged_title, filename = "../claeys-et-al/claeys-plots-adjust-yaxis.svg", width = 20, height = 10)
